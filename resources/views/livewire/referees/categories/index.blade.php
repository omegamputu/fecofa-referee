...
<div>
    <div class="container mx-auto w-full max-w-5xl px-6">
        <section class="bg-white dark:bg-neutral-900 dark:rounded-xl py-6 px-6 rounded-3xl">
            <!-- Session Status -->
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <flux:modal.trigger name="create-category">
                    <flux:button variant="primary" color="green" class="cursor-pointer">{{ __("Add category") }}
                    </flux:button>
                </flux:modal.trigger>
            </div>
