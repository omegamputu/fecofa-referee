...
<div>
    <div class="container mx-auto h-full w-full max-w-5xl">
            ...
            <div class="flex items-center justify-between mb-6 gap-4">
                ...
                @can('create_referee')
                    <flux:button variant="primary" color="green" class="shrink-0 cursor-pointer"
                        :href="route('instructors.create')" wire:navigate>
                        {{ __('Add instructor') }}
                    </flux:button>
                @endcan
                            ...
                            <tr class="dark:text-slate-400">
                                ...
                                <td class="px-4 py-3">
                                    @if ($instructor->is_active)
                                        <flux:badge color="green" size="sm" class="dark:text-white dark:bg-green-500">
                                            {{ __("Active") }}
                                        </flux:badge>
                                    @else
